...
**4. [LEX Jurisprudential Compass](https://www.wolterskluwer.com/pl-pl/solutions/lex/kompas-orzeczniczy) — auto-summarization (Poland).** My contribution was within the auto-summarization part of this tool, which helps lawyers make sense of a rapidly growing body of court rulings. Relatively smaller to other projects but with a scale potential as across two years also Germany, Czechia and Hungary benefited from similar framework.
...
**MCP.** Completed the [Model Context Protocol course](https://learn.deeplearning.ai/accomplishments/f417d9e2-775e-4d54-ae31-e86f07c1db47?usp=sharing) from DeepLearning.AI — a useful deep-dive into one of the more practically interesting protocol developments in the AI tooling space.
...
[The Lean Startup](https://www.goodreads.com/book/show/10127019-the-lean-startup) by Eric Ries. Still relevant, maybe more so in the context of AI products where it's tempting to over-build before validating. The build-measure-learn loop is simple advice that's easy to ignore under deadline pressure.

[The Pragmatic Engineer](https://newsletter.pragmaticengineer.com/) by Gergely Orosz remains my most-recommended read in this space. It covers AI's effect on the industry, engineering culture, and the job market in a way that feels grounded rather than hype-driven. Good for staying calibrated.

[Lenny's Podcast](https://www.lennyspodcast.com/) — particularly the episodes on [Shape Up](https://basecamp.com/shapeup). The framing of appetite over estimates and the separation between shaping and building gave me useful language for conversations I was already having. Not a methodology I'd apply wholesale, but the thinking behind it is worth sitting with.
